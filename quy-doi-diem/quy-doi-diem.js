...
HUST: {
        ...
        TSA: [
            ...
            // Dải cao - Chia nhỏ nhất có thể (Từng 1 điểm TSA)
...
// DÁN HSA_TABLE_DATA NGAY DƯỚI ĐÂY
...
// Các trường quy đổi theo khoảng
...
.addEventListener("click", () => {
    ...
    if (HSA_TABLE_DATA[school]) {
        ...
        if (examType !== "HSA") {
            ...
            resultBox.innerHTML =
                "Nhóm này chỉ hỗ trợ HSA";

            return;
        }

        const value =
            HSA_TABLE_DATA[school][Math.round(score)];
    ...
    // Nhóm trường nội suy
    const ranges =
        UNIVERSITY_DATA[school][examType];
    ...
    if (result === null) {
        ...
        resultBox.innerHTML =
            "Không tìm thấy khoảng điểm phù hợp";
